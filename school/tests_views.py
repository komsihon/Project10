...
class SchoolViewsTestCase(unittest.TestCase):
    ...
    @override_settings(IKWEN_SERVICE_ID='56eb6d04b37b3379b531b101', CACHES=None)
    def test_ChangeLevel_with_create_new_level(self):
        """
    ...
    @override_settings(IKWEN_SERVICE_ID='56eb6d04b37b3379b531b101', CACHES=None)
    def test_ChangeLevel_with_update_level(self):
        """
        Upon update, name and list of subject must be properly set
        """
        self.client.login(username='member2', password='admin')
        name = u'Prépa'
    ...
    @override_settings(IKWEN_SERVICE_ID='56eb6d04b37b3379b531b101', CACHES=None)
    def test_ChangeSubject_with_create_new_subject(self):
        """
    ...
    @override_settings(IKWEN_SERVICE_ID='56eb6d04b37b3379b531b101', CACHES=None)
    def test_ChangeSession_with_create_new_session(self):
        """
        Upon creation, name must be properly set
        """
        self.client.login(username='member2', password='admin')
        ...
        self.assertEqual(response.status_code, 200)
        name = u'Séquence 1'
        self.client.post(reverse('school:change_session'), {'name': name})
        session = Session.objects.get(name=name)
        self.assertIsNotNone(session)

    @override_settings(IKWEN_SERVICE_ID='56eb6d04b37b3379b531b101', CACHES=None)
    def test_ChangeSession_with_update_session(self):
        """
        Upon update, name must be properly set
        """
        self.client.login(username='member2', password='admin')
        name = u'Séquence 1'
        self.client.post(reverse('school:change_session', args=('58b217ec25de1dd789524fc1', )), {'name': name})
